...
const BalanceChart = React.lazy(() => import('./features/charts/BalanceChart'));
// const LoanChart = React.lazy(() => import('./LoanChart'));
const LoanChart = React.lazy(() => import('./features/charts/LoanChart'));
// const AnalyticsChart = React.lazy(() => import('./AnalyticsChart'));
const AnalyticsChart = React.lazy(() => import('./features/charts/AnalyticsChart'));
